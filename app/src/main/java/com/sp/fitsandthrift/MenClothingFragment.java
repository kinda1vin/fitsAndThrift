...
public class MenClothingFragment extends Fragment {
    private ImageView backImageView;
    private ImageView cartButton;
    private boolean isCardDisplayed = true;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_men_clothing, container, false);
